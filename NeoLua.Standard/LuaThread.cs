  ...
  public sealed class LuaThread : IAsyncResult, IDisposable
  {
    ...
    public LuaResult EndResume(IAsyncResult ar)
    {
      lock (this)
        ...
        {
          if (this != ar)
            throw new LuaRuntimeException(Resources.rsCoroutineInvalidAR, 2, false);

          if (lockResume == null)
            throw new LuaRuntimeException(Resources.rsCoroutineNoBeginResume, 2, false);
    ...
    public static LuaResult yield(object[] args)
    {
      ...
      if (t == null)
        throw new LuaRuntimeException(Resources.rsCoroutineWrongThread, 2, false);
    ...
    public static LuaResult status(object co)
    {
      LuaThread luaThread = co as LuaThread;
			if (luaThread != null)
			{
				...
				throw new LuaRuntimeException(Resources.rsCoroutineInvalidCO, 2, false);
    } // func running
