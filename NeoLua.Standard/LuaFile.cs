...
namespace Neo.IronLua
{
	...
	///////////////////////////////////////////////////////////////////////////////
	/// <summary></summary>
	public class LuaLinesEnumerator : System.Collections.IEnumerator
	{
	...
	public class LuaFile : IDisposable
	{
		...
		{
			if (tr == null)
				return new LuaResult(null, Resources.rsFileNotReadable);
		...
		{
			if (tw == null)
				return new LuaResult(null, Resources.rsFileNotWriteable);
		...
		public virtual LuaResult seek(string whence, long offset = 0)
			=> new LuaResult(null, Resources.rsFileNotSeekable);
